    ...
    <CardShell status="basic" onPress={hasReviews ? onViewAll : undefined}>
      <Stack gap="md">
        ...
        <Row justify="space-between" align="center">
          ...
          {hasReviews && (
            <Row gap="xs" align="center">
              <AppText variant="label" status="surf" style={styles.bold}>View All</AppText>
        ...
        {!hasReviews ? (
          ...
          <Row gap="md" align="center">
            <View style={styles.ratingContainer}>
              <Row gap="xs" align="center">
                <AppText variant="h2" style={styles.avgRatingText}>
                  {avgRating?.toFixed(1)}
                </AppText>
        ...
        <AppText variant="label" status="hint" style={styles.disclaimer}>
          Community reviews help others plan their visit. You can add yours after checking in.
        </AppText>
      </Stack>
    </CardShell>
  );
